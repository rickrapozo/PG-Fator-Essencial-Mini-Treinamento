...
const StickyHeader = () => {
  ...
  return (
    <header className="hidden md:block fixed top-0 w-full z-[10000] bg-bg-primary/80 backdrop-blur-md border-b border-gold-dark/30 transition-all duration-300">
